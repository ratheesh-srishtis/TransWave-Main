...
const AddEmployeeExceptFileUploadIssue = () => {
        ...
        case "certificatesRecord":
          ...
          if (isEditing) {
            ...
            editUpdatedCertificateFields = certificateFields.map((field) => {
              ...
              if (field._id === parseInt(certificateFieldId)) {
                return {
                  ...field,
                  document: {
          ...
          if (isEditing) {
            ...
            //console.log('Updated Fields:', editUpdatedCertificateFields);
          } else {
...
export default AddEmployeeExceptFileUploadIssue;
