...
const Immigration_Guarantee_Letter_Dubai_New_Drydock = ({
  open,
  onClose,
  charge,
  ...
  return (
    <>
      <Dialog open={open} onClose={handleClose} fullWidth maxWidth="md">
        <DialogTitle>Immigration Guarantee Letter</DialogTitle>
        <DialogContent>
...
export default Immigration_Guarantee_Letter_Dubai_New_Drydock;
